...
ArkOffice does not ship an `ee/` directory. Do not add one: upstream's
enterprise tree uses a separate non-Apache license and is intentionally
excluded from this fork (enforced by CI).
