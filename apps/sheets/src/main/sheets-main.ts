...
import { createI18n, getUiLang, type Lang, normalizeLang, setUiLang } from '@arkoffice/i18n'
...
/** office/pdf formats extract text via @arkoffice/file-parse; images skip text
...
/** Attachment text extraction via @arkoffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
...
async function prepareWorkbookForOpen(
  ...
  const directory = join(app.getPath('temp'), 'arkoffice-imports', randomUUID())
