...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiNotLoggedIn: '未登录（AI 功能需要登录云端工具）',
  ...
  ko: {
    ...
    aiAccountLabel: '클라우드 도구',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 클라우드 도구 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginAccount: 'ArkOffice 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiAccountLabel: 'Compte ArkOffice',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un outils cloud)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginAccount: 'Se connecter aux outils cloud',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  es: {
    ...
    aiAccountLabel: 'Cuenta de ArkOffice',
    aiAccountChecking: 'Comprobando…',
    aiLoggedIn: 'Sesión iniciada',
    aiLoggedInAs: 'Sesión iniciada: {email}',
    aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una herramientas cloud)',
    aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
    aiLoginAccount: 'Iniciar sesión en herramientas cloud',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
  ...
  ru: {
    ...
    aiAccountLabel: 'Учётная запись ArkOffice',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись ArkOffice)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginAccount: 'Войти в ArkOffice',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiAccountLabel: 'حساب ArkOffice',
    aiAccountChecking: 'جارٍ التحقق…',
    aiLoggedIn: 'تم تسجيل الدخول',
    aiLoggedInAs: 'تم تسجيل الدخول: {email}',
    aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب ArkOffice)',
    aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
    aiLoginAccount: 'تسجيل الدخول إلى ArkOffice',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
  ...
  pt: {
    ...
    aiAccountLabel: 'Conta ArkOffice',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta ArkOffice)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    aiLoginAccount: 'Entrar no ArkOffice',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
  ...
  nl: {
    ...
    aiAccountLabel: 'ArkOffice-account',
    aiAccountChecking: 'Controleren…',
    aiLoggedIn: 'Aangemeld',
    aiLoggedInAs: 'Aangemeld: {email}',
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een ArkOffice-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginAccount: 'Aanmelden bij ArkOffice',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  he: {
    ...
    aiAccountLabel: 'חשבון ArkOffice',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון ArkOffice)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginAccount: 'כניסה ל-ArkOffice',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiAccountLabel: 'ArkOffice खाता',
    aiAccountChecking: 'जांच हो रही है…',
    aiLoggedIn: 'साइन इन किया गया',
    aiLoggedInAs: 'साइन इन: {email}',
    aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए ArkOffice खाता आवश्यक है)',
    aiWaitingBrowserLogin: 'ब्राउज़र में साइन इन की प्रतीक्षा…',
    aiLoginAccount: 'ArkOffice में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
  ...
  'zh-TW': {
    ...
    aiAccountLabel: 'ArkOffice 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 ArkOffice 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginAccount: '登入 ArkOffice',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
