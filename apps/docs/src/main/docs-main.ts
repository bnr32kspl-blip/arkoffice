...
import { createI18n, getUiLang, normalizeLang, setUiLang } from '@arkoffice/i18n'
...
import { parseFileToText } from '@arkoffice/file-parse'
import {
  AiCreditsError,
  AiTimeoutError,
  chatForProvider,
...
const tMain = createI18n({
  zh: {
    ...
    menuWindow: '窗口',
    menuHelp: '帮助',
    menuDocsHelp: 'ArkOffice Docs 帮助',
  },
  en: {
    ...
    menuWindow: 'Window',
    menuHelp: 'Help',
    menuDocsHelp: 'ArkOffice Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    menuWindow: 'ウィンドウ',
    menuHelp: 'ヘルプ',
    menuDocsHelp: 'ArkOffice Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    menuWindow: '창',
    menuHelp: '도움말',
    menuDocsHelp: 'ArkOffice Docs 도움말',
  },
  fr: {
    ...
    menuWindow: 'Fenêtre',
    menuHelp: 'Aide',
    menuDocsHelp: 'Aide ArkOffice Docs',
  },
  de: {
    ...
    menuWindow: 'Fenster',
    menuHelp: 'Hilfe',
    menuDocsHelp: 'ArkOffice Docs-Hilfe',
  },
  es: {
    ...
    menuWindow: 'Ventana',
    menuHelp: 'Ayuda',
    menuDocsHelp: 'Ayuda de ArkOffice Docs',
  },
  th: {
    ...
    menuWindow: 'หน้าต่าง',
    menuHelp: 'วิธีใช้',
    menuDocsHelp: 'วิธีใช้ ArkOffice Docs',
  },
  id: {
    ...
    menuWindow: 'Jendela',
    menuHelp: 'Bantuan',
    menuDocsHelp: 'Bantuan ArkOffice Docs',
  },
  ru: {
    ...
    menuWindow: 'Окно',
    menuHelp: 'Справка',
    menuDocsHelp: 'Справка ArkOffice Docs',
  },
  ar: {
    ...
    menuWindow: 'نافذة',
    menuHelp: 'تعليمات',
    menuDocsHelp: 'تعليمات ArkOffice Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    menuWindow: 'Janela',
    menuHelp: 'Ajuda',
    menuDocsHelp: 'Ajuda do ArkOffice Docs',
  },
  it: {
    ...
    menuWindow: 'Finestra',
    menuHelp: 'Aiuto',
    menuDocsHelp: 'Guida di ArkOffice Docs',
  },
  pl: {
    ...
    menuWindow: 'Okno',
    menuHelp: 'Pomoc',
    menuDocsHelp: 'Pomoc ArkOffice Docs',
  },
  nl: {
  ...
  he: {
    ...
    menuWindow: 'חלון',
    menuHelp: 'עזרה',
    menuDocsHelp: 'עזרה של ArkOffice Docs',
  },
  hi: {
    ...
    menuWindow: 'विंडो',
    menuHelp: 'सहायता',
    menuDocsHelp: 'ArkOffice Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    menuWindow: '視窗',
    menuHelp: '說明',
    menuDocsHelp: 'ArkOffice Docs 說明',
  },
})
...
export function defaultSaveDir(): string {
  const dir = join(app.getPath('documents'), 'ArkOffice')
...
/** office/pdf formats get text extracted via @arkoffice/file-parse; images skip extraction and go multimodal (files:read-image) */
...
function savePastedImage(data: unknown, ext: unknown): string | null {
  ...
  const dir = join(app.getPath('temp'), 'arkoffice-pasted')
  mkdirSync(dir, { recursive: true })
...
/** parse an attachment to text via @arkoffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
...
// implementations live in @arkoffice/ai-provider, shared with apps/sheets.
...
export function startDocsStandalone(): void {
  ...
  // the installed ArkOffice Docs is open and forwards its argv there instead.
  if (isDev) app.setPath('userData', join(app.getPath('appData'), 'ArkOffice Docs Dev'))
  ...
  app.whenReady().then(() => {
    setUiLang(normalizeLang(process.env.ARKOFFICE_LANG ?? app.getLocale()))
