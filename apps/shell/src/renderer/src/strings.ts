...
export const strings = {
  zh: {
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 ArkOffice,请检查网络或代理设置',
    ...
    versionLabel: '版本',
    settings: '设置',
    settingsSub: '语言、本地 AI 与云端',
    cloudFeatures: '云端功能',
    cloudFeaturesHint: '允许可选的在线服务（网页搜索、PDF→Word、AI 图像生成等）。默认关闭，适合本地使用。',
    cloudFeaturesConfirmTitle: '开启云端功能？',
    cloudFeaturesConfirmDetail: '部分功能会将数据发送到外部服务。可随时在设置中关闭。',
    cloudFeaturesEnable: '开启',
    cloudFeaturesKeepOff: '保持关闭',
    // Dates
    today: '今天',
    yesterday: '昨天',
    daysAgo: '{n}天前',
    ...
    onbTitle1: '欢迎使用 ArkOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'ArkOffice 目前处于 alpha 阶段。欢迎加入 Community 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ ArkOffice 积分**',
    onbJoinCommunity: '加入 Community',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    ...
    onbNote3: 'AI 功能可能消耗 ArkOffice 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach ArkOffice — check your network or proxy settings',
    ...
    settings: 'Settings',
    settingsSub: 'Language, local AI & cloud',
    cloudFeatures: 'Cloud features',
    cloudFeaturesHint: 'Allow optional online services (web search, PDF→Word, AI image generation). Off by default for local use.',
    cloudFeaturesConfirmTitle: 'Enable cloud features?',
    cloudFeaturesConfirmDetail: 'Some features send data to external services. You can turn this off anytime in Settings.',
    cloudFeaturesEnable: 'Enable',
    cloudFeaturesKeepOff: 'Keep off',
    today: 'Today',
    yesterday: 'Yesterday',
    daysAgo: '{n}d ago',
    language: 'Language',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to ArkOffice',
    ...
    onbBody2:
      'ArkOffice is still in alpha. Join the group chat on Community to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ ArkOffice credits**',
    onbJoinCommunity: 'Join Community',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features may consume ArkOffice credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    account: 'アカウント',
    login: 'サインイン',
    loginAccount: 'アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInAccount: 'サインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'ArkOffice に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    versionLabel: 'バージョン',
    settings: '設定',
    settingsSub: '言語・ローカル AI・クラウド',
    cloudFeatures: 'クラウド機能',
    cloudFeaturesHint: '任意のオンラインサービス（ウェブ検索、PDF→Word、AI画像生成など）を許可します。ローカル利用のため既定はオフです。',
    cloudFeaturesConfirmTitle: 'クラウド機能をオンにしますか？',
    cloudFeaturesConfirmDetail: '一部の機能は外部サービスにデータを送信します。設定からいつでもオフにできます。',
    cloudFeaturesEnable: 'オンにする',
    cloudFeaturesKeepOff: 'オフのまま',
    // Dates
    today: '今日',
    yesterday: '昨日',
    daysAgo: '{n}日前',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'ArkOffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'ArkOffice はまだアルファ版です。Community のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ ArkOffice クレジット**',
    onbJoinCommunity: 'Community に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は ArkOffice クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    noContent: '(내용 없음)',
    // Account
    accountLabel: '클라우드 도구',
    account: '계정',
    login: '로그인',
    loginAccount: '클라우드 도구으로 로그인',
    loggedIn: '로그인됨',
    loggedInAccount: 'ArkOffice에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'ArkOffice에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'ArkOffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'ArkOffice는 아직 알파 단계입니다. Community 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ ArkOffice 크레딧**',
    onbJoinCommunity: 'Community 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 ArkOffice 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    accountLabel: 'Compte ArkOffice',
    account: 'Compte',
    login: 'Se connecter',
    loginAccount: 'Se connecter avec ArkOffice',
    loggedIn: 'Connecté',
    loggedInAccount: 'Connecté à ArkOffice',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre ArkOffice — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans ArkOffice',
    ...
    onbBody2:
      'ArkOffice est encore en alpha. Rejoignez la discussion de groupe sur Community pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits ArkOffice**',
    onbJoinCommunity: 'Rejoindre Community',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits ArkOffice.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    accountLabel: 'Cloud-Tools',
    account: 'Konto',
    login: 'Anmelden',
    loginAccount: 'Mit ArkOffice anmelden',
    loggedIn: 'Angemeldet',
    loggedInAccount: 'Bei ArkOffice angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'ArkOffice ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei ArkOffice',
    ...
    onbBody2:
      'ArkOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Community bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ ArkOffice-Guthaben**',
    onbJoinCommunity: 'Community beitreten',
    ...
    onbNote3: 'KI-Funktionen können ArkOffice-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    accountLabel: 'Cuenta de ArkOffice',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginAccount: 'Iniciar sesión con ArkOffice',
    loggedIn: 'Sesión iniciada',
    loggedInAccount: 'Sesión iniciada en ArkOffice',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con ArkOffice — compruebe su red o la configuración del proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a ArkOffice',
    ...
    onbBody2:
      'ArkOffice aún está en alfa. Únete al chat grupal en Community para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de ArkOffice**',
    onbJoinCommunity: 'Unirse a Community',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de ArkOffice.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    accountLabel: 'บัญชี ArkOffice',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginAccount: 'ลงชื่อเข้าใช้ด้วย ArkOffice',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInAccount: 'ลงชื่อเข้าใช้ ArkOffice แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ ArkOffice ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ ArkOffice',
    ...
    onbBody2:
      'ArkOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Community เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต ArkOffice กว่า 1,000**',
    onbJoinCommunity: 'เข้าร่วม Community',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต ArkOffice',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    accountLabel: 'Akun ArkOffice',
    account: 'Akun',
    login: 'Masuk',
    loginAccount: 'Masuk dengan ArkOffice',
    loggedIn: 'Sudah masuk',
    loggedInAccount: 'Sudah masuk ke ArkOffice',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke ArkOffice — periksa jaringan atau pengaturan proxy Anda',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di ArkOffice',
    ...
    onbBody2:
      'ArkOffice masih dalam tahap alpha. Gabung obrolan grup di Community untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit ArkOffice**',
    onbJoinCommunity: 'Gabung Community',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit ArkOffice.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    noContent: '(пусто)',
    // Account
    accountLabel: 'Учётная запись ArkOffice',
    account: 'Учётная запись',
    login: 'Войти',
    loginAccount: 'Войти через ArkOffice',
    loggedIn: 'Вход выполнен',
    loggedInAccount: 'Выполнен вход в ArkOffice',
    ...
    loginNetworkError: 'Не удаётся подключиться к ArkOffice — проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в ArkOffice',
    ...
    onbBody2:
      'ArkOffice пока в альфа-версии. Присоединяйтесь к групповому чату в Community, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов ArkOffice**',
    onbJoinCommunity: 'Присоединиться к Community',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты ArkOffice.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    accountLabel: 'حساب ArkOffice',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginAccount: 'تسجيل الدخول باستخدام ArkOffice',
    loggedIn: 'تم تسجيل الدخول',
    loggedInAccount: 'تم تسجيل الدخول إلى ArkOffice',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ ArkOffice — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في ArkOffice',
    ...
    onbBody2:
      'لا يزال ArkOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على Community لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة ArkOffice**',
    onbJoinCommunity: 'الانضمام إلى Community',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة ArkOffice.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountLabel: 'Conta ArkOffice',
    account: 'Conta',
    login: 'Entrar',
    loginAccount: 'Entrar com a ArkOffice',
    loggedIn: 'Conectado',
    loggedInAccount: 'Conectado à ArkOffice',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao ArkOffice — verifique sua rede ou as configurações de proxy',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao ArkOffice',
    ...
    onbBody2:
      'O ArkOffice ainda está em alfa. Entre no chat em grupo no Community para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos ArkOffice**',
    onbJoinCommunity: 'Entrar no Community',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos ArkOffice.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    noContent: '(vuoto)',
    accountLabel: 'Account ArkOffice',
    account: 'Account',
    login: 'Accedi',
    loginAccount: 'Accedi con ArkOffice',
    loggedIn: 'Accesso effettuato',
    loggedInAccount: 'Accesso effettuato a ArkOffice',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere ArkOffice — controlla la rete o le impostazioni del proxy',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in ArkOffice',
    ...
    onbBody2:
      'ArkOffice è ancora in alpha. Unisciti alla chat di gruppo su Community per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti ArkOffice**',
    onbJoinCommunity: 'Unisciti a Community',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti ArkOffice.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountLabel: 'Konto ArkOffice',
    account: 'Konto',
    login: 'Zaloguj się',
    loginAccount: 'Zaloguj się przez ArkOffice',
    loggedIn: 'Zalogowano',
    loggedInAccount: 'Zalogowano do ArkOffice',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z ArkOffice — sprawdź sieć lub ustawienia proxy',
    ...
    onbBody2:
      'ArkOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na Community, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów ArkOffice**',
    onbJoinCommunity: 'Dołącz do Community',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty ArkOffice.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    untitled: 'Naamloos',
    noContent: '(leeg)',
    accountLabel: 'ArkOffice-account',
    account: 'Account',
    login: 'Inloggen',
    loginAccount: 'Inloggen met ArkOffice',
    loggedIn: 'Ingelogd',
    loggedInAccount: 'Ingelogd bij ArkOffice',
    ...
    loginNetworkError: 'Kan ArkOffice niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij ArkOffice',
    ...
    onbBody2:
      'ArkOffice is nog in alfa. Doe mee aan de groepschat op Community om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ ArkOffice-credits**',
    onbJoinCommunity: 'Word lid van Community',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen ArkOffice-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    accountLabel: 'Akaun ArkOffice',
    account: 'Akaun',
    login: 'Log masuk',
    loginAccount: 'Log masuk dengan ArkOffice',
    loggedIn: 'Telah log masuk',
    loggedInAccount: 'Telah log masuk ke ArkOffice',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke ArkOffice — semak rangkaian atau tetapan proksi anda',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke ArkOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'ArkOffice masih dalam peringkat alfa. Sertai sembang kumpulan di Community untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit ArkOffice**',
    onbJoinCommunity: 'Sertai Community',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit ArkOffice.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountLabel: 'חשבון ArkOffice',
    account: 'חשבון',
    login: 'התחברות',
    loginAccount: 'התחברות עם ArkOffice',
    loggedIn: 'מחובר',
    loggedInAccount: 'מחובר ל-ArkOffice',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-ArkOffice — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-ArkOffice',
    ...
    onbBody2:
      'ArkOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Community כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות ArkOffice**',
    onbJoinCommunity: 'הצטרפו ל-Community',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של ArkOffice.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    accountLabel: 'ArkOffice खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginAccount: 'ArkOffice से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInAccount: 'ArkOffice में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'ArkOffice से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'ArkOffice में आपका स्वागत है',
    ...
    onbBody2:
      'ArkOffice अभी अल्फ़ा में है। Community पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ ArkOffice क्रेडिट**',
    onbJoinCommunity: 'Community से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ ArkOffice क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountLabel: 'ArkOffice 帳號',
    account: '帳號',
    login: '登入',
    loginAccount: '登入 ArkOffice 帳號',
    loggedIn: '已登入',
    loggedInAccount: '已登入 ArkOffice',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 ArkOffice，請檢查網路或代理設定',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 ArkOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'ArkOffice 目前仍在 alpha 階段。歡迎加入 Community 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ ArkOffice 點數**',
    onbJoinCommunity: '加入 Community',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 ArkOffice 點數。',
    onbBack: '上一步',
  },
} as const
