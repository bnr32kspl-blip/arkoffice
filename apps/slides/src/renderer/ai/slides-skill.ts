import type { AgentSkill, ToolDisplay } from '@arkoffice/agent-core'
import type {
  GroupRenderNode,
  PictureRenderNode,
  RenderNode,
...
const AGENT_SYSTEM_PROMPT = `You are the AI assistant inside ArkOffice Slides (a slide editor), helping users improve and generate presentations.
