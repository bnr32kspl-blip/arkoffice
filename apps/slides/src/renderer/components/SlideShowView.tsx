...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@arkoffice/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@arkoffice/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@arkoffice/pptx-render').PictureRenderNode).media,
  )
