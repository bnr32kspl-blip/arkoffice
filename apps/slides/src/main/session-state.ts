/**
 * Shared main-process state for ArkOffice Slides, extracted from slides-main.ts so
...
import { materializeSlide, type OpenedPptx, type Slide } from '@arkoffice/pptx-engine'
import {
  buildRenderSlide,
